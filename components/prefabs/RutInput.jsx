...
export default function RutInput({
    ...
    return (<><div className={`rounded border border-[#d5c7aa] px-3 mb-2 text-xl bg-white focus:border-[#ac9164] focus:ring-2 focus:ring-[#fad379]/20 ${className}`}>
        <input
            ref={inputRef}
            type="text"
            value={value}
            ...
            className={`w-full
                    ...
                    transition-all duration-200 bg-transparent h-8
                `}
            {...props}
        />
        </div>
